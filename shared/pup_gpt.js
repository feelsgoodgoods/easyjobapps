// console.log("pup_gpt.js: Loaded");
// import { db } from "./routes_db.js";

let { getSitemap, crawlUrl, scrapeLinks, search_companyOnDuckDuckGo } = await import("./pup.js") 
// await import("../utils/utils_pup.js");
...
async function sitemapUpdateLinkText(body) {
  ...
  let link = await db.getLinkById(sitemap_id, user_id);
