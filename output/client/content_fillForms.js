...
let sendGenerated = async (type, text, base64EncodedData) => {   
  ...
  console.log('toAppAction handleAutoLoad RETURNED:', response) // companyName, company_id, id, jobTitle, link, meta, reject, status, text, user_id
 
  // if(!response){
  //   console.log('AN ERROR ORCCURED GETTING POST');
  // }  
  // if(response){
  //   console.log('Updating postData locally')
  //   window.postData = response 
  // } 
} 
...
async function refin_yaml(givenText = false) { 
